...
| `feedbackRecords:read`  | `list_feedback_datasets`, `list_feedback_records`, `get_feedback_record`, `search_feedback_records`, `find_similar_feedback_records` |
| `feedbackRecords:write` | `create_feedback_record`, `delete_feedback_record`                                                                                   |
