...
1. **UI Components**: Reusable, presentational components in the `modules/ui/components` directory
...
_This document reflects the current structure of our codebase and is regularly updated as patterns evolve._