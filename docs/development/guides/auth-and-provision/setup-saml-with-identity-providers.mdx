...
<Steps>
  ...
  <Step title="Head over to the Sign On tab and click on the 'view SAML setup instructions' button">
    <img src="/images/development/guides/auth-and-provision/okta/view-saml-instructions.png" />
  </Step>
  <Step title="Scroll to the bottom and copy the IDP metadata">
    <img src="/images/development/guides/auth-and-provision/okta/idp-metadata.png" />
  </Step>
  <Step title="Paste the IDP metadata in environment variable SAML_RAW_METADATA" />
</Steps>
