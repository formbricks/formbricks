...
- **Survey Response Data**: Option to attach detailed survey response data
...
5. **Configuring Recipients**:
   ...
   - Team member emails (selectable directly from the survey editor)
...
7. **Configuring the Email Content**:
   ...
   - Survey Response Data: Option to include detailed survey response data with supported rendering for:
     - File uploads
     - Images
     - Rankings
     - Translations
...
8. **Additional Options**:
   ...
   - **Duplicate**: You can duplicate existing follow-up configurations for quick reuse
   
   <img src="/images/xm-and-surveys/core-features/email-followups/duplicate-follow-up.webp" alt="Duplicate follow-up option" width="70%" />
