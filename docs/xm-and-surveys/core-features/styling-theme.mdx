...
The Form Styling section gives you granular control over every text and input element in your survey. Expand the **Form Styling** panel to find collapsible sub-sections for Headlines & Descriptions, Inputs, Buttons, and Options.
