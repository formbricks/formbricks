---
title: "Link Surveys vs In-app Surveys"
description: "This guide explains the differences between Link Surveys and In-app Surveys to help you choose the right option."
...
- Survey timing is tied to a known event
...
Also known as **intercept surveys**. Requires SDK integration. Formbricks handles targeting and survey fatigue.
...
- Global waiting time (e.g., one survey every 7 days per user)
...
<AccordionGroup>
  <Accordion title="Do you control survey timing externally?">
    Use **Link Surveys**. Send the URL when the moment is right. Pass context via Hidden Fields.
  </Accordion>
