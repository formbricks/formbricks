...
5. Validate the reviewed Compose configuration privately and pull the pinned images. Apply the release's
   Formbricks database migrations only after writers are stopped: `docker compose run --rm --no-deps formbricks-migrate`.
