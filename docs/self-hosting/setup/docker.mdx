...
<Warning>
  For production deployments with HTTPS and a subdomain, use the
  <a href="/self-hosting/setup/one-click">one-click setup script</a>. It configures Traefik, TLS (Let’s
  Encrypt), CORS, rate limiting, and sane defaults for MinIO.
</Warning>
