...
1. **Create the Environment File**
   ...
   installations can omit `FORMBRICKS_IMAGE_REF` and use `ghcr.io/formbricks/formbricks:latest`. For an
   ...
   it is omitted, all four use the stable `latest` alias together so those processes cannot drift. Keep
