...
controller, set `envoy.controller.enabled: false`, keep `envoy.crds.enabled: false`, disable GatewayClass creation,
and provide the existing GatewayClass name. In either mode, configure
