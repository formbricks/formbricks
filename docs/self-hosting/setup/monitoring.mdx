...
The v6 direct-authority release removes comparison telemetry and requires authoritative allow/deny/operational-
error and latency metrics plus outbox backlog, oldest pending revocation, dead-letter, reconciliation drift, and
repair signals. A revocation warns at 15 seconds, becomes critical at 45 seconds, and makes protected
authorization fail closed at 60 seconds. Follow the release-matched
