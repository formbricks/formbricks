...
Formbricks exposes bounded projection and authorization-comparison metrics when AuthZed is enabled. Monitor
projection failures and disabled outcomes, shadow mismatches, authorization operational errors, and authorization
latency. Also monitor SpiceDB pod availability, datastore migrations, PostgreSQL pool saturation, dispatch
