...
[rate-limiting guide](/self-hosting/configuration/rate-limiting) for the exact route coverage.

### Cube Is Part Of The Baseline

Cube is part of the supported Formbricks v5 stack and powers analytics flows that depend on Cube queries. The
