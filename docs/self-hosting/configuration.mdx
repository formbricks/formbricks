...
<Card title="AI Features" icon="sparkles" href="/self-hosting/configuration/ai-features">
  Point the instance at Qwen/vLLM, Google Cloud, Azure or Bedrock, and turn AI on for your organization.
</Card>

## Keeping the instance healthy

<CardGroup cols={2}>
  <Card title="AuthZed Operations" icon="shield-halved" href="/self-hosting/configuration/authzed-operations">
    Configure, monitor, back up and repair the SpiceDB authorization dependency.
  </Card>

  <Card title="Rate Limiting" icon="timer" href="/self-hosting/configuration/rate-limiting">
    The limits Envoy and the application server apply, and how to tune them.
  </Card>
</CardGroup>
