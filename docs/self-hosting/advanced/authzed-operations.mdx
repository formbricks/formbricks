...
| `formbricks_authzed_authorization_duration_seconds`  | End-to-end authoritative authorization latency                               |
...
histogram_quantile(
  0.95,
  sum by (le, surface) (rate(formbricks_authzed_authorization_duration_seconds_bucket[5m]))
)
