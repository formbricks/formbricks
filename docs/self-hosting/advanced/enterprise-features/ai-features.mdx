...
This page covers deploying the bundled Qwen/vLLM runtime. To connect any provider, including an existing external one, see [AI Setup](/self-hosting/configuration/ai-setup).
