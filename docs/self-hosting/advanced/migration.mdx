...
- decide whether this instance needs AI features (dashboards/analysis are part of the baseline now)
- budget approximately ~500 MB additional RAM headroom for the bundled Cube container
