...
After the container starts, check the logs to see whether the value backfill was completed or skipped:
...
If the migration skipped the value backfill, run the standalone backfill script inside the running container:
