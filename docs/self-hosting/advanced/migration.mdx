...
Records API or the MCP server, and nothing else. If you do not use Unify Feedback, or you only reach it
through the UI, there is nothing to do for it. The release adds no new environment variables. It does ship
