...
Records API or the MCP server, and nothing else. It needs no environment variables and no database
migrations. If you do not use Unify Feedback, or you only reach it through the UI, there is nothing to do
for it.
