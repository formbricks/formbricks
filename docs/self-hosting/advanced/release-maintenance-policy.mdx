...
is published. Release candidates and the date you installed it do not count.
...
After its support-end date, a minor receives no further fixes of any kind. Upgrade to a maintained minor to
