...
<Steps>
  ...
  <Step title="IdP Application">
    Create a SAML application in your IdP by following your provider's instructions. See [SAML with Identity Providers](/self-hosting/configuration/auth-sso/setup-saml-with-identity-providers) for the values Formbricks expects.
  </Step>
