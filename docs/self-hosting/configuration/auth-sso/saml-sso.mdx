...
<Steps>
  ...
  <Step title="IdP Application">
    Create a SAML application in your IdP by following your provider's instructions([SAML Setup](/self-hosting/configuration/auth-sso/setup-saml-with-identity-providers))
  </Step>
