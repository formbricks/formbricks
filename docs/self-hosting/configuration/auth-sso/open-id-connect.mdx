...
<Warning>
  **Upgrading from an earlier version?** This path changed at v5.2 and reverted at v5.4:
  ...
  If you followed the v5.2 migration guide and left the pre-v5.2 URI registered at your OIDC provider,
  there is nothing to do — v5.4 simply starts using it again. Only add it back if you removed it after
  upgrading to v5.2. See the [migration guide](/self-hosting/advanced/migration) for details.
</Warning>
