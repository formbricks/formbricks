...
<Note>
  **Using Okta or Keycloak?** Both have step-by-step guides:
  [Okta OIDC](/self-hosting/configuration/auth-sso/okta-oidc) and
  [Keycloak OIDC](/self-hosting/configuration/auth-sso/keycloak-oidc).
</Note>
