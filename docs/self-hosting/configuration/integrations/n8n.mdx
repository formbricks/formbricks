...
Voila! You have successfully enabled the n8n integration in your self-hosted Formbricks instance. Now you can follow the steps mentioned in the [Formbricks Integrations](/platform/features/integrations/n8n) section to know more about the capabilities with Formbricks with n8n.
