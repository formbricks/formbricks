...
2. `BETTER_AUTH_URL`: The authentication URL (should be the same as WEBAPP_URL)

### Example Configuration

```bash
WEBAPP_URL=https://formbricks.example.com
BETTER_AUTH_URL=https://formbricks.example.com
```
...
BETTER_AUTH_URL=https://admin.formbricks.example.com
