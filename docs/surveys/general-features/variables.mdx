...
![The Embedded Data card, with the calculated field score beside two passed-in fields](/images/surveys/embedded-data/editor-card.webp)

The `score` row above is a calculated field: **Calculated** as its source, `0` as the value it starts at, and a generated address you never type.
