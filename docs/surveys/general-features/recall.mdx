...
![Survey setup example with link survey template](/images/surveys/general-features/recall/step-three.webp)
...
![Dropdown menu for recalling data in survey](/images/surveys/general-features/recall/step-two.webp)
...
![Setting fallback option in survey question](/images/surveys/general-features/recall/step-one.webp)
