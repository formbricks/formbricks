...
<Warning>
  ...
  December 2026**. Workflows offer the same response- and ending-based email automation plus additional
  triggers and actions. Build new email automations as Workflows, and rebuild your existing follow-ups
  as Workflows before that date.

  The Follow-ups tab is now hidden in the survey editor unless the survey already has follow-ups, or
  Workflows are unavailable on your plan or license.
</Warning>
