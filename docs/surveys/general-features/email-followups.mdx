...
<Warning>
  Email Follow-ups are deprecated in favor of [Workflows](/workflows/overview) and stop working on **1
  December 2026**. Workflows cover the same ground — a completed response, optionally narrowed to specific
  ending cards, sending an email — and are where this is being developed. Build new email automations as
  Workflows, and rebuild your existing follow-ups as Workflows before that date.

  The Follow-ups tab is now hidden in the survey editor unless the survey already has follow-ups, or
  your plan includes follow-ups but not Workflows.
</Warning>
