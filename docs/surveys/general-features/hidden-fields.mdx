...
2. Choose **New field**, give it a name, and leave the source on **Passed in**. Add as many as you need.

The same card is where you give a field a type, a default value, or a lock — see [Embedded Data](/surveys/embedded-data/overview).
