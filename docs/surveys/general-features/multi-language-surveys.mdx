...
<Steps>
  <Step title="Configure Survey Languages">
    ...
    ![Survey Configuration](/images/surveys/general-features/multi-language-surveys/workspace-configuration.webp)
    ...
    ![Add Multiple Languages to your Workspace](/images/surveys/general-features/multi-language-surveys/add-languages.webp)
  ...
  <Step title="Create or Edit Your Survey">
    ...
    ![Survey Overview](/images/surveys/general-features/multi-language-surveys/surveys-home.webp)
  </Step>
  ...
  <Step title="Enable Multi-language Support">
    ...
    ![Enable Multi-language for a survey](/images/surveys/general-features/multi-language-surveys/enable-multi-lang.webp)
  ...
  <Step title="Add Supported Languages">
    ...
    ![Enable Multi-language for a survey](/images/surveys/general-features/multi-language-surveys/add-language-in-survey.webp)
  </Step>
...
<Steps>
  ...
  <Step title="Automatic RTL Display">
    ...
    ![RTL Language Support](/images/surveys/general-features/multi-language-surveys/rtl-support.webp)
  </Step>
</Steps>
