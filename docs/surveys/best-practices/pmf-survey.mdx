...
![Create survey by template](/images/surveys/best-practices/pmf-survey/create-survey.webp)
...
![Change text content](/images/surveys/best-practices/pmf-survey/change-text.webp)
/>

_Want to change the button color? You can do so in **Settings → Workspace → Appearance**!_
...
![Set recontact options](/images/surveys/best-practices/pmf-survey/recontact-options.webp)

### 7. Congrats! You’re ready to publish your survey 💃

![Publish survey](/images/surveys/best-practices/pmf-survey/publish.webp)
