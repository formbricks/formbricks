...
![Create feedback box by template](/images/surveys/best-practices/feedback-box/create-feedback-box-by-template.webp)

### 2. Update question content

Change the questions and answer options according to your preference:

![Change text content](/images/surveys/best-practices/feedback-box/change-text-content.webp)
...
![Add action](/images/surveys/best-practices/feedback-box/add-action.webp)
...
![Add HTML action](/images/surveys/best-practices/feedback-box/action-innertext.webp)
...
![Add CSS action](/images/surveys/best-practices/feedback-box/action-css.webp)

### 4. Select action in the “When to ask” card

![Select feedback button action](/images/surveys/best-practices/feedback-box/select-action.webp)
...
![Set recontact options](/images/surveys/best-practices/feedback-box/set-recontact-options.webp)

### 6. You’re ready publish your survey!

![Publish survey](/images/surveys/best-practices/feedback-box/publish-survey.webp)

## Setting up the Widget

<Note>Formbricks Widget running? You need to have the Formbricks Widget installed to display the Feedback Box in your app. Please follow [this tutorial (Step 4 onwards)](/surveys/website-app-surveys/quickstart) to install the widget.</Note>