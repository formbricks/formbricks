...
<Steps>
  ...
  <Step title="Download the responses CSV">
    ...
    ![Download responses CSV](/images/surveys/best-practices/panel-management/download-responses.webp)
  ...
  <Step title="Create segments for targeting">
    ...
    Create multiple segments for different research needs. Learn more about [Advanced Targeting](/surveys/website-app-surveys/advanced-targeting) for detailed segmentation options.
...
- [Advanced Targeting](/surveys/website-app-surveys/advanced-targeting) - Explore detailed segmentation options
