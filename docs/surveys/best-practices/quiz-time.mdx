...
Scroll to the **Embedded Data** card below the question list, choose **Add field** then **Create new field**, set the source to **Calculated** and the type to **Number**, name it `score` and give it a default of `0`.
