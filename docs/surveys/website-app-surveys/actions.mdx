...
<Step title="Check for survey trigger">
  ...
  <Step title="Check for user or visitor qualification">
    If the user or visitor already filled out a survey in the past couple of days (see [Workspace-wide Survey Cooldown](/surveys/website-app-surveys/cooldown-period)), the survey will not be shown to prevent survey fatigue.
