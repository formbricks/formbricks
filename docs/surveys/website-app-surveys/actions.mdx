...
<Step title="Check for survey trigger">
  ...
  <Step title="Check for user or visitor qualification">
    If the user or visitor was already **shown** a survey in the past couple of days (see [Cooldown Period](/surveys/website-app-surveys/cooldown-period)), this one will not be shown, to prevent survey fatigue. The gate counts displays, not answers — declining to answer still starts the clock.
