...
<Steps>
  ...
  <Step title="Choose 'In-product surveys'">
    ...
    ![three options](/images/surveys/website-app-surveys/quickstart/survey-type.webp)
...
<Step title="Connect your App/Website">
  ...
  <Step title="Create trigger to show survey">
    ...
    ![page view action](/images/surveys/website-app-surveys/quickstart/page-view-action.webp)
  ...
  ![recontact options](/images/surveys/website-app-surveys/quickstart/recontact-options.webp)
