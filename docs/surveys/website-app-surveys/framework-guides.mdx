...
Once you've completed the steps above, validate your setup by checking the Setup Checklist on the **Connect Your App** page under **Settings → Workspace**. The widget status indicator should change from this:
