...
- A Formbricks account with your **Workspace ID** and **API host**, available on the **Connect Your App** page under **Workspace Settings**.
...
Once you've completed the steps above, validate your setup by checking the Setup Checklist on the **Connect Your App** page under **Workspace Settings**. The widget status indicator should change from this:
