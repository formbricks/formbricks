...
| `feedbackRecords:write` | `create_feedback_record`, `create_feedback_records`, `delete_feedback_record`                                                                                  | Create and delete feedback records                                        |
...
<Warning>
  ...
  `feedbackRecords:write` only to clients you want to be able to delete feedback, and keep read-only agents on
