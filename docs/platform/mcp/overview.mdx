...
The MCP server exposes survey, workflow, response and feedback-record tools, grouped into scopes you
approve on the consent screen. Read tools require the matching `:read` scope; tools that create, update, or delete
