...
![Formbricks Integrations Tab](/images/platform/features/integrations/slack/integrations-tab.webp)

1. Now click on the "Connect with Slack" button to authenticate yourself with Slack.

![Connect Formbricks with your Slack Workspace](/images/platform/features/integrations/slack/connect-with-slack.webp)
...
![Formbricks is now connected with Slack](/images/platform/features/integrations/slack/slack-connected.webp)
...
![Add Formbricks Bot](/images/platform/features/integrations/slack/add-slack-bot-4.webp)

1. Now click on the "Link channel" button to link a Slack channel with Formbricks and a modal will open up.

![Link Formbricks with a Slack Channel](/images/platform/features/integrations/slack/link-survey-with-channel.webp)
...
![Delete Slack Integration with Formbricks](/images/platform/features/integrations/slack/delete-connection.webp)
