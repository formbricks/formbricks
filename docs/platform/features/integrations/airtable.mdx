...
![Formbricks is now connected with Google](/images/platform/features/integrations/airtable/airtable-connected.webp)
...
![Link Formbricks with a Airtable](/images/platform/features/integrations/airtable/link-survey-with-table.webp)
