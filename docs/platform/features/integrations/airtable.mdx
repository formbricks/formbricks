...
![Formbricks Integration Tab](/images/platform/features/integrations/airtable/integrations-tab.webp)

1. Now click on the "Connect with Airtable" button to authenticate yourself with Airtable.

![Connect Formbricks with Airtable](/images/platform/features/integrations/airtable/connect-with-airtable.webp)
...
![Formbricks is now connected with Airtable](/images/platform/features/integrations/airtable/airtable-connected.webp)

<Note>
  Before the next step, make sure that you have a Formbricks Survey with at least one question and an Airtable
...
![Link Formbricks with an Airtable base](/images/platform/features/integrations/airtable/link-survey-with-table.webp)
...
![Delete Airtable Integration with Formbricks](/images/platform/features/integrations/airtable/delete-integration.webp)
