...
Go to **Workspace Settings → Connect Your App** where you’ll find your workspaceId:

![Run targeted surveys for free on WordPress pages](/images/platform/features/integrations/wordpress/3-wordpress-setup-survey-on-website-targeted-free-open-source.webp)
