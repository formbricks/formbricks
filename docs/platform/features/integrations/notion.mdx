...
![Formbricks Integrations Tab](/images/platform/features/integrations/notion/integrations-tab.webp)

1. Now click on the "Connect with Notion" button to authenticate yourself with Notion.

![Connect Formbricks with your Notion account](/images/platform/features/integrations/notion/connect-with-notion.webp)
...
![Formbricks is now connected with Notion](/images/platform/features/integrations/notion/notion-connected.webp)
...
![Link Formbricks with a Notion database](/images/platform/features/integrations/notion/link-survey-with-database.webp)
...
![Delete Notion Integration with Formbricks](/images/platform/features/integrations/notion/delete-connection.webp)
