...
![Formbricks Integrations Tab](/images/platform/features/integrations/google-sheets/integrations-tab.webp)

1. Now click on the "Connect with Google" button to authenticate yourself with Google.

![Connect Formbricks with your Google](/images/platform/features/integrations/google-sheets/connect-with-google.webp)
...
![Formbricks is now connected with Google](/images/platform/features/integrations/google-sheets/google-connected.webp)
...
![Link Formbricks with a Google Sheet](/images/platform/features/integrations/google-sheets/link-survey-with-sheet.webp)
...
![Delete Google Integration with Formbricks](/images/platform/features/integrations/google-sheets/delete-connection.webp)
