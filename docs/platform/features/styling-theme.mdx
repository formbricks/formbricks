...
In the left sidebar, open **Workspace Settings** and go to the **Appearance** page:

![Appearance](/images/platform/features/styling-theme/form-css-styling.webp)
...
<Steps>
  <Step title="Open Logo Settings">
    ...
    ![Logo upload box](/images/platform/features/styling-theme/step-four.webp)
  </Step>

  <Step title="Upload Your Logo">
    Upload your logo. Logos must be 5 MB or less.

    ![Upload logo](/images/platform/features/styling-theme/step-five.webp)
  </Step>
  ...
  <Step title="Add Background Color (Optional)">
    ...
    ![Logo background color](/images/platform/features/styling-theme/step-six.webp)
  </Step>

  <Step title="Save">
    Remember to save your changes!

    ![Save changes](/images/platform/features/styling-theme/step-seven.webp)
  </Step>
</Steps>
...
![Allow overwrite toggle](/images/platform/features/styling-theme/allow-overwrite.webp)
