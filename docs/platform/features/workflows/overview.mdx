...
Self-hosted deployments run Workflows through the Redis-backed runner built into the Formbricks web process.
Before using Workflows in production, configure Redis and any services required by your actions, such as SMTP
for **Send email**.

<Card title="Configure the Workflow Runner" icon="gears" href="/self-hosting/configuration/workflow-runner">
