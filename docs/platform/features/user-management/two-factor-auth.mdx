...
1. Navigate to **Account Settings → Your Profile** via the menu in the lower right corner
...
1. Go to **Account Settings → Your Profile** and scroll to the **Security** section
