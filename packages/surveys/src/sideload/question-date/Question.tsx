    ...
    <div className="relative h-40">
      {!datePickerOpen && (
        <div
          ...
          className="bg-input-bg hover:bg-input-bg-selected relative flex h-40 w-full cursor-pointer appearance-none items-center justify-center rounded-lg border border-slate-300 text-left text-base font-normal text-slate-900 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-1">
