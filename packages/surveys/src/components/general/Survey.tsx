  ...
  return (
    <>
      <AutoCloseWrapper survey={survey} onClose={onClose}>
        <div className="no-scrollbar flex h-full w-full flex-col justify-center rounded-lg bg-[--fb-survey-background-color] px-6 pb-3 pt-6">
          <div ref={contentRef} className={cn(loadingElement ? "animate-pulse opacity-60" : "", "")}>
