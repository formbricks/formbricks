  ...
  return (
    <div>
      ...
      <form
        ...
        <label className="relative z-10 mt-4 flex w-full cursor-pointer items-center rounded-md border border-[--fb-border] bg-[--fb-bg] p-4 text-sm text-[--fb-text] focus:outline-none">
          <input
            type="checkbox"
            id={question.id}
            name={question.id}
