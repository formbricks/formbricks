            ...
            {Array.from({ length: 11 }, (_, i) => i).map((number, idx) => (
              <label
                ...
                className={cn(
                  ...
                  "bg-survey-bg text-heading  md:hover:bg-accent-bg relative h-10 flex-1 cursor-pointer border text-center text-sm leading-10 first:rounded-l-md last:rounded-r-md focus:outline-none"
                )}>
                <input
                  type="radio"
                  name="nps"
