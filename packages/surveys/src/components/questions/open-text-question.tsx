          ...
          <div className="fb:mt-4">
            {question.longAnswer === false ? (
              <input
                ...
                className="fb:border-border fb:placeholder:text-placeholder fb:text-subheading fb:focus:border-brand fb:bg-input-bg fb:rounded-custom fb:block fb:w-full fb:border fb:p-2 fb:shadow-sm fb:focus:outline-hidden fb:focus:ring-0 fb:sm:text-sm"
              ...
              <textarea
                ...
                className="fb:border-border fb:placeholder:text-placeholder fb:bg-input-bg fb:text-subheading fb:focus:border-brand fb:rounded-custom fb:block fb:w-full fb:border fb:p-2 fb:shadow-sm fb:focus:ring-0 fb:sm:text-sm"
