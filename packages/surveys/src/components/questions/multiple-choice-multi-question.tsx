                  ...
                  return (
                    <label
                      ...
                      className={cn(
                        ...
                        "fb:text-heading fb:focus-within:border-brand fb:hover:bg-input-bg-selected fb:focus:bg-input-bg-selected fb:rounded-custom fb:relative fb:flex fb:cursor-pointer fb:flex-col fb:border fb:p-4 fb:focus:outline-hidden"
                      )}
                      onKeyDown={(e) => {
