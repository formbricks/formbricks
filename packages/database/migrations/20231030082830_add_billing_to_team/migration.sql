...
ADD COLUMN     "billing" JSONB NOT NULL DEFAULT '{"stripeCustomerId": null, "features": {"appSurvey": {"status": "inactive", "unlimited": false}, "linkSurvey": {"status": "inactive", "unlimited": false}, "userTargeting": {"status": "inactive", "unlimited": false}}}';
