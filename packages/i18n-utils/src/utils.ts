...
export const iso639Languages = [
  ...
  },
  {
    code: "de-LU",
    label: {
      "en-US": "German (Luxembourg)",
      "de-DE": "Deutsch (Luxemburg)",
      "pt-BR": "Alemão (Luxemburgo)",
      "fr-FR": "Allemand (Luxembourg)",
      "zh-Hant-TW": "德語（盧森堡）",
      "pt-PT": "Alemão (Luxemburgo)",
      "ro-RO": "Germană (Luxemburg)",
      "ja-JP": "ドイツ語（ルクセンブルク）",
      "zh-Hans-CN": "德语（卢森堡）",
      "nl-NL": "Duits (Luxemburg)",
      "es-ES": "Alemán (Luxemburgo)",
      "sv-SE": "Tyska (Luxemburg)",
      "ru-RU": "Немецкий (Люксембург)",
      "hu-HU": "Német (Luxemburg)",
      "tr-TR": "Almanca (Lüksemburg)",
    },
  },
  {
    code: "dv",
  ...
  },
  {
    code: "fr-LU",
    label: {
      "en-US": "French (Luxembourg)",
      "de-DE": "Französisch (Luxemburg)",
      "pt-BR": "Francês (Luxemburgo)",
      "fr-FR": "Français (Luxembourg)",
      "zh-Hant-TW": "法語（盧森堡）",
      "pt-PT": "Francês (Luxemburgo)",
      "ro-RO": "Franceză (Luxemburg)",
      "ja-JP": "フランス語（ルクセンブルク）",
      "zh-Hans-CN": "法语（卢森堡）",
      "nl-NL": "Frans (Luxemburg)",
      "es-ES": "Francés (Luxemburgo)",
      "sv-SE": "Franska (Luxemburg)",
      "ru-RU": "Французский (Люксембург)",
      "hu-HU": "Francia (Luxemburg)",
      "tr-TR": "Fransızca (Lüksemburg)",
    },
  },
  {
    code: "fy",
  ...
  },
  {
    code: "it-CH",
    label: {
      "en-US": "Italian (Switzerland)",
      "de-DE": "Italienisch (Schweiz)",
      "pt-BR": "Italiano (Suíça)",
      "fr-FR": "Italien (Suisse)",
      "zh-Hant-TW": "義大利語（瑞士）",
      "pt-PT": "Italiano (Suíça)",
      "ro-RO": "Italiană (Elveția)",
      "ja-JP": "イタリア語（スイス）",
      "zh-Hans-CN": "意大利语（瑞士）",
      "nl-NL": "Italiaans (Zwitserland)",
      "es-ES": "Italiano (Suiza)",
      "sv-SE": "Italienska (Schweiz)",
      "ru-RU": "Итальянский (Швейцария)",
      "hu-HU": "Olasz (Svájc)",
      "tr-TR": "İtalyanca (İsviçre)",
    },
  },
  {
    code: "iu",
  ...
  },
  {
    ...
    label: {
      "en-US": "Dutch (Belgium)",
      "de-DE": "Niederländisch (Belgien)",
      "pt-BR": "Holandês (Bélgica)",
      "fr-FR": "Néerlandais (Belgique)",
      "zh-Hant-TW": "荷蘭語（比利時）",
      "pt-PT": "Holandês (Bélgica)",
      "ro-RO": "Olandeză (Belgia)",
      "ja-JP": "オランダ語（ベルギー）",
      "zh-Hans-CN": "荷兰语（比利时）",
      "nl-NL": "Nederlands (België)",
      "es-ES": "Holandés (Bélgica)",
      "sv-SE": "Nederländska (Belgien)",
      "ru-RU": "Голландский (Бельгия)",
      "hu-HU": "Holland (Belgium)",
      "tr-TR": "Felemenkçe (Belçika)",
    },
  },
  {
    code: "nn",
