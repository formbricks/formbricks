...
const translateChoice = (choice: any, languages: string[], defaultLanguageSymbol: string) => {
...
export const translateQuestion = (
  ...
  clonedQuestion.subheader = clonedQuestion.subheader
    ? createI18nString(question.subheader ?? "", languages, defaultLanguageSymbol)
    : undefined;
  clonedQuestion.buttonLabel = createI18nString(question.buttonLabel ?? "", languages, defaultLanguageSymbol);
