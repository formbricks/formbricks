      ...
      questions: [
        {
          ...
          type: TSurveyQuestionTypeEnum.CTA,
          logic: [{ condition: "skipped", destination: "end:1" }],
      ...
      questions: [
        {
          ...
          logic: [
            ...
            { value: "I just didn't need it anymore", condition: "equals", destination: "end:1" },
          ],
          choices: [
        ...
        },
        {
          ...
          type: TSurveyQuestionTypeEnum.OpenText,
          logic: [{ condition: "submitted", destination: "end:1" }],
        ...
        },
        {
          ...
          type: TSurveyQuestionTypeEnum.CTA,
          logic: [{ condition: "clicked", destination: "end:1" }],
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          ...
          type: TSurveyQuestionTypeEnum.MultipleChoiceSingle,
          logic: [{ value: "No", condition: "equals", destination: "end:1" }],
          shuffleOption: "none",
          choices: [
            { id: createId(), label: { default: "Yes" } },
            { id: createId(), label: { default: "No" } },
      ...
      questions: [
        {
          ...
          logic: [
            ...
            { value: "I was just looking around", condition: "equals", destination: "end:1" },
          ],
          choices: [
        ...
        },
        {
          ...
          type: TSurveyQuestionTypeEnum.OpenText,
          logic: [
            { condition: "submitted", destination: "end:1" },
            { condition: "skipped", destination: "end:1" },
          ],
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          ...
          type: TSurveyQuestionTypeEnum.CTA,
          logic: [
            { condition: "clicked", destination: "end:1" },
            { condition: "skipped", destination: "end:1" },
          ],
    ...
    preset: {
      ...
      questions: [
        ...
        },
        {
          id: createId(),
          type: TSurveyQuestionTypeEnum.Rating,
          logic: [{ value: "5", condition: "equals", destination: "end:1" }],
          range: 5,
          scale: "number",
      ...
      questions: [
        {
          ...
          logic: [
            ...
            { value: "5", condition: "equals", destination: "end:1" },
          ],
          range: 5,
          scale: "number",
