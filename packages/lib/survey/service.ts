...
import { buildOrderByClause, buildWhereClause, transformPrismaSurvey } from "./utils";
...
export const getSyncSurveys = reactCache(
  (environmentId: string, personId: string, deviceType: "phone" | "desktop" = "desktop") => {
    console.log("getSyncSurveys");
    console.log({ environmentId, personId, deviceType });
  }
  // cache(
  //   async () => {
  //     validateInputs([environmentId, ZId]);
