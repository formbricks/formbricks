...
function Progress({ className, value, ...props }: ProgressProps): React.JSX.Element {
  ...
  return (
    // @ts-ignore - React types version mismatch - the project uses React 19 types, but some Radix UI packages (@radix-ui/react-progress and react-day-picker) bundle their own older React types, creating incompatible Ref type definitions
