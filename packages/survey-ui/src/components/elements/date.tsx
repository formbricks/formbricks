    ...
    <div className="w-full space-y-4" id={elementId} dir={dir}>
      ...
      <div className="relative" data-element-input>
        ...
        {/* Calendar - Always visible. The value is picked from a grid of day buttons, so there is
            no single native control to flag: a native <fieldset> (role="group") wraps them and
            carries the invalid state. It is named by the headline via aria-labelledby rather than a
            <legend>, so the headline's media/required badge are not nested in invalid block
            content; m-0/p-0/border-0/min-w-0 reset the fieldset UA defaults so it lays out like a
            plain div. */}
        <fieldset
