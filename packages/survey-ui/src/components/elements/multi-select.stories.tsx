...
const meta: Meta<StoryProps> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A complete multi-select question element that combines headline, description, and checkbox options. Supports multiple selections, validation, and RTL text direction.",
      },
    },
  },
  tags: ["autodocs"],
