/*
  ...
  - The values [CD_BU,CD_EQ,CD_HK,CD_HL,CD_HU,CD_IT,CD_KS,CD_KC,CD_KE,CD_KN,CD_BC,CD_KG,CD_KL,CD_LO,CD_LU,CD_MN,CD_MA,CD_MO,CD_NK,CD_NU,CD_SA,CD_SK,CD_SU,CD_TA,CD_TO,CD_TU] on the enum `Province` will be removed. If these variants are still used in the database, this will fail.
