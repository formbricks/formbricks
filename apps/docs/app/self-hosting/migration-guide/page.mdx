...
Formbricks v2.3 includes new color options for rating questions, enhanced multi-language functionality for chinese language (simplified & traditional) and different bug fixes and performance improvements.
