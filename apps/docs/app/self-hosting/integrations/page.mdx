...
<Note>
  {" "}
  Once you’ve configured your integration, See our Integration sections to see how to use them within your
  Formbricks app [here](/developer-docs/integrations/airtable)
</Note>
...
<Note>
  If your Google Cloud Console project has a publishing status of "Testing" your refresh token will expire
  after 7 days. To avoid that, you need to change the publishing status to "Production". [Google OAuth 2.0
  documentation](https://developers.google.com/identity/protocols/oauth2?hl=en#expiration)
</Note>
