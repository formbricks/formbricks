...
import AddFormbricksTrigger from "./images/n8n/add-formbricks-trigger.png";
import FillDiscordDetails from "./images/n8n/fill-discord-details.png";
import ListenForEvent from "./images/n8n/listen-for-event.png";
import SelectEvent from "./images/n8n/select-event.png";
import SelectSurvey from "./images/n8n/select-survey.png";
import SelectedSurveys from "./images/n8n/selected-surveys.png";
import SubmitTestResponse from "./images/n8n/submit-test-response.png";
import SuccessConnection from "./images/n8n/success-connection.png";
import TestResponseSuccess from "./images/n8n/test-response-success.png";
import AddApiKey from "./images/n8n/add-api-key.png";
import AddDiscord from "./images/n8n/add-discord.png";
import CreateNewCredentialBtn from "./images/n8n/create-new-credential-btn.png";
import DiscordResponse from "./images/n8n/discord-response.png";
...
6. Test your trigger: In order to set up n8n you'll need a test response in the selected survey. This allows you to select the individual values of each response in your workflow. If you have Formbricks running locally and you want to set up an app survey, you can use our [Demo App](/docs/contributing/demo) to trigger a survey and submit a response.
