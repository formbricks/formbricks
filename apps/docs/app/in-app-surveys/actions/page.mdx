...
1. **Configure the Action**: First, add the action via the Formbricks web interface to make it available for survey configuration. View our App Survey JS SDK here.
