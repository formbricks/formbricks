...
1. Go to the Integrations tab in your [Formbricks Cloud dashboard](https://app.formbricks.com/) or `https://localhost:3000` if you are running locally and click on the "Manage" button under Mattermost integration.
...
4. Make sure to add this in the meta information field of that form. This makes sure that the responses goes to your mattermost server.This is an important step. Don't skip it.
...
4. You can send any of your mattermost supported parameters mentioned [here](https://developers.mattermost.com/integrate/webhooks/incoming/#parameters) in this meta information field.
...
Congratulations!!! You have succesfully added webhook to connect to your mattermost server. Now whenever a response is submitted for the linked survey, it will be automatically sent to the linked Mattermost channel.
