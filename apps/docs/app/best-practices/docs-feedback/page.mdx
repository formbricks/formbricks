...
4. Change the Question ID of the first question to **“isHelpful”** to make your life easier 😉
...
5. In the same way, you can change the Question ID of the _Please elaborate_ question to **“additionalFeedback”** and the one of the _Page URL_ question to **“pageUrl”**.
...
6. Click on “Settings" tab to configure Response Options such as response limits, redirections and more:
...
7. Once you're happy will your Response Options configuration, publish your survey 🤝 
