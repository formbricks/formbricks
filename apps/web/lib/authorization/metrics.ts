...
const meter = metrics.getMeter("formbricks.bridge.authorization");

const decisionsTotal = meter.createCounter("formbricks_bridge_authorization_decisions_total", {
  description: "Authoritative bridge PostgreSQL authorization decisions by bounded outcome",
});
...
const authorizationDuration = meter.createHistogram(
  "formbricks_bridge_authorization_decision_duration_seconds",
  {
    ...
    description: "Duration of authoritative bridge PostgreSQL authorization operations",
    unit: "s",
  }
);
 ...
 */
const checksPerRequest = meter.createHistogram("formbricks_bridge_authorization_checks_per_request", {
  advice: {
