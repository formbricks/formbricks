...
export const PRISMA_AUTHORIZATION_RESOURCE_INVENTORY = {
  ...
  AuthzedActivationReceipt: "authentication_or_application",
  AuthzedAuthorizationControl: "authentication_or_application",
  AuthzedProjectionOutbox: "authentication_or_application",
  AuthzedUpgradeRun: "authentication_or_application",
