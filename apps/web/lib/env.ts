...
export const env = createEnv({
  ...
  server: {
    ...
    CLOUD_STRIPE_PRODUCT_ID_HOBBY: z.string().optional(),
    CLOUD_STRIPE_PRODUCT_ID_PRO: z.string().optional(),
    CLOUD_STRIPE_PRODUCT_ID_SCALE: z.string().optional(),
    CLOUD_STRIPE_PRODUCT_ID_TRIAL: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    CLOUD_STRIPE_PRODUCT_ID_HOBBY: process.env.CLOUD_STRIPE_PRODUCT_ID_HOBBY,
    CLOUD_STRIPE_PRODUCT_ID_PRO: process.env.CLOUD_STRIPE_PRODUCT_ID_PRO,
    CLOUD_STRIPE_PRODUCT_ID_SCALE: process.env.CLOUD_STRIPE_PRODUCT_ID_SCALE,
    CLOUD_STRIPE_PRODUCT_ID_TRIAL: process.env.CLOUD_STRIPE_PRODUCT_ID_TRIAL,
