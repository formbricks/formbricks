...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_PRODUCT_ID_HOBBY: z.string().optional(),
    STRIPE_PRODUCT_ID_PRO: z.string().optional(),
    STRIPE_PRODUCT_ID_SCALE: z.string().optional(),
    STRIPE_PRODUCT_ID_TRIAL: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    STRIPE_PRODUCT_ID_HOBBY: process.env.STRIPE_PRODUCT_ID_HOBBY,
    STRIPE_PRODUCT_ID_PRO: process.env.STRIPE_PRODUCT_ID_PRO,
    STRIPE_PRODUCT_ID_SCALE: process.env.STRIPE_PRODUCT_ID_SCALE,
