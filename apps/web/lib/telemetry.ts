...
// We are using the hashed WEBAPP_URL as the distinct identifier for the instance for telemetry.
...
const getTelemetryId = (): string => {
  return crypto.createHash("sha256").update(WEBAPP_URL).digest("hex");
};
