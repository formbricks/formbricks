...
import { IS_PRODUCTION, SENTRY_DSN, SENTRY_RELEASE } from "@/lib/constants";
  ...
  return (
    <html lang={locale} translate="no">
      <body className="flex h-dvh flex-col transition-all ease-in-out">
        <SentryProvider sentryDsn={SENTRY_DSN} sentryRelease={SENTRY_RELEASE} isEnabled={IS_PRODUCTION}>
