...
export const getEnvironmentIdFromApiKey = reactCache(
  async (apiKey: string): Promise<Pick<ApiKey, "environmentId"> | null> => {
    ...
    return cache(
      async () => {
        ...
        try {
          ...
          return { environmentId: apiKeyData.environmentId };
        } catch (error) {
