...
export default function CustomUrlConfirmationPage() {
        ...
        <div className="mx-auto max-w-sm py-8 sm:px-6 lg:px-8">
          <div className="my-6 sm:flex-auto">
            <h1 className="text-center text-xl font-semibold text-slate-900">
              Custom URL for Link Survey purchased successfully!
            </h1>
            <p className="mt-2 text-center text-sm text-slate-700">
              You will now be able to use your own custom URL for link surveys.
            </p>
          </div>
