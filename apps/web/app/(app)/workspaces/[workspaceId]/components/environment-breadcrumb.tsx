...
export const EnvironmentBreadcrumb = ({
  ...
  // Do not render the environment switcher when operating under workspace routes —
  // environments are being deprecated and the switcher only makes sense on legacy paths.
