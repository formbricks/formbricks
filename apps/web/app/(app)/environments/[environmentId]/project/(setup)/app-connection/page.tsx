...
import { EnvironmentIdField } from "@/app/(app)/environments/[environmentId]/project/(setup)/components/EnvironmentIdField";
import { SetupInstructions } from "@/app/(app)/environments/[environmentId]/project/(setup)/components/SetupInstructions";
