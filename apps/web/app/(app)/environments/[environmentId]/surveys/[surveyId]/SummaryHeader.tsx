  ...
  return (
    <div className="mb-11 mt-6 flex flex-wrap items-center justify-between">
      ...
      <div className="block sm:hidden">
        <DropdownMenu>
          <DropdownMenuTrigger>
            <div className="px-3 py-2 text-sm leading-4 font-mediumtext-slate-600 hover:text-slate-500 bg-slate-200 hover:bg-slate-100 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-1  focus:bg-slate-300 focus:ring-neutral-500 h-full w-full rounded-md p-2">
