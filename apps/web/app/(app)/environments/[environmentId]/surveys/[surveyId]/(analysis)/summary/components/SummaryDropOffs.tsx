  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50 shadow-sm">
      <div className="rounded-b-lg bg-white ">
        <div className="grid h-10 grid-cols-6 items-center border-y border-slate-200 bg-slate-100 text-sm font-bold text-slate-600">
          <div className="col-span-3 pl-4 md:pl-6">Questions</div>
          <div className="pr-6 text-center md:pl-6">Drop-off</div>
          <div className="flex justify-center px-4 text-center font-bold text-slate-600 md:px-6">
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
