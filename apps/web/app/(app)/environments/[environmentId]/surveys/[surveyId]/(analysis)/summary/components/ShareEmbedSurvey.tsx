...
export const ShareEmbedSurvey = ({
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="w-full max-w-xl bg-white p-0 md:max-w-3xl lg:h-[700px] lg:max-w-5xl">
          {showView === "start" ? (
            ...
            <PanelInfoView handleInitialPageButton={handleInitialPageButton} unableBack={true} />
          ) : null}
        </DialogContent>
      </Dialog>
    );
  ...
  } else if (modalType === "panel") {
    return (
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="w-full max-w-xl bg-white p-0 md:max-w-3xl lg:h-[700px] lg:max-w-5xl">
          <PanelInfoView handleInitialPageButton={handleInitialPageButton} unableBack={false} />
        </DialogContent>
      </Dialog>
    );
  }
