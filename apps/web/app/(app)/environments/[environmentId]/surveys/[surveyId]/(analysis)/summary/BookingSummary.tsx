...
interface BookingSummaryProps {
  questionSummary: QuestionSummary<TSurveyBookingQuestion>;
...
export default function BookingSummary({ questionSummary, environmentId }: BookingSummaryProps) {
  return (
    <div className="rounded-lg border border-slate-200 bg-slate-50 shadow-sm">
      <div className="space-y-2 px-4 pb-5 pt-6 md:px-6">
        ...
        <div className="flex space-x-2 text-xs font-semibold text-slate-600 md:text-sm">
          <div className="rounded-lg bg-slate-100 p-2 ">Booking Status</div>
