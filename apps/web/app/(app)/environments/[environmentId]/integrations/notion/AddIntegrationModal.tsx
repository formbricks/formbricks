...
interface AddIntegrationModalProps {
  ...
  selectedIntegration: (TNotionConfigData & { index: number }) | null;
}
...
export default function AddIntegrationModal({
  ...
  const linkDatabase = async () => {
    try {
      ...
      if (selectedIntegration) {
        // update action
        (notionIntegrationData.config!.data as TNotionConfig["data"])[selectedIntegration.index] =
          integrationData;
      } else {
        // create action
        (notionIntegrationData.config!.data as TNotionConfig["data"]).push(integrationData);
      }
