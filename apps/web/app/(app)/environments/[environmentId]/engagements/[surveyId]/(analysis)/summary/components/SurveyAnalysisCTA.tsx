...
import { ShareEmbedSurvey } from "@/app/(app)/environments/[environmentId]/engagements/[surveyId]/(analysis)/summary/components/ShareEmbedSurvey";
import { SuccessMessage } from "@/app/(app)/environments/[environmentId]/engagements/[surveyId]/(analysis)/summary/components/SuccessMessage";
import { SurveyStatusDropdown } from "@/app/(app)/environments/[environmentId]/engagements/[surveyId]/components/SurveyStatusDropdown";
...
export const SurveyAnalysisCTA = ({
  ...
  const iconActions = [
    ...
    },
    {
      ...
      onClick: () => router.push(`/environments/${environment.id}/engagements/${survey.id}/edit`),
      isVisible: !isReadOnly,
    },
  ];
