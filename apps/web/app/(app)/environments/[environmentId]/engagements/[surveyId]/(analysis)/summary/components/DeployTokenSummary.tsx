...
import { TSurvey, TSurveyQuestionSummaryDeployToken } from "@formbricks/types/surveys/types";
import { QuestionSummaryHeader } from "./QuestionSummaryHeader";

interface DeployTokenSummaryProps {
  questionSummary: TSurveyQuestionSummaryDeployToken;
  environmentId: string;
  survey: TSurvey;
}

export const DeployTokenSummary = ({ questionSummary, environmentId, survey }: DeployTokenSummaryProps) => {
