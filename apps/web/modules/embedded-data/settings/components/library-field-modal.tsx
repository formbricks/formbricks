    ...
    <>
      ...
      {pendingTypeChange && field && (
        <ConfirmationModal
          ...
          // this dialog, so a Cancel that only cleared `pendingTypeChange` returned the author to the
          // form while the write went on to succeed, toast and close the dialog under them — the one
