...
export const GET = async (
  ...
  authenticatedApiClient({
    ...
    handler: async ({ authentication, parsedInput }) => {
      ...
      if (!hasPermission(authentication.environmentPermissions, res.data.workspaceId, "GET")) {
...
export const PUT = async (
  ...
  authenticatedApiClient({
    ...
    handler: async ({ authentication, parsedInput, auditLog }) => {
      ...
      if (!hasPermission(authentication.environmentPermissions, res.data.workspaceId, "PUT")) {
...
export const DELETE = async (
  ...
  authenticatedApiClient({
    ...
    handler: async ({ authentication, parsedInput, auditLog }) => {
      ...
      if (!hasPermission(authentication.environmentPermissions, res.data.workspaceId, "DELETE")) {
        return handleApiError(
          request,
          {
            type: "unauthorized",
