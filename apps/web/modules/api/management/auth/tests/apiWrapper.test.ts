...
import { apiWrapper } from "@/modules/api/management/auth/apiWrapper";
import { authenticateRequest } from "@/modules/api/management/auth/authenticateRequest";
...
vi.mock("@/modules/api/lib/rate-limit", () => ({
