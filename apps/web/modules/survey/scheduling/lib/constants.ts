...
export const SURVEY_SCHEDULING_TIME_ZONE = env.NEXT_PUBLIC_SURVEY_SCHEDULING_TIME_ZONE;
export const SURVEY_SCHEDULING_LOCAL_HOUR = env.NEXT_PUBLIC_SURVEY_SCHEDULING_LOCAL_HOUR;
export const SURVEY_SCHEDULING_LOCAL_MINUTE = env.NEXT_PUBLIC_SURVEY_SCHEDULING_LOCAL_MINUTE;
