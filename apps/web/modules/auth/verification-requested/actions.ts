...
export const resendVerificationEmailAction = securityActionClient("email_verification_request")
  .inputSchema(ZResendVerificationEmailAction)
  .action(async ({ ctx, parsedInput }) => {
    const audit: SecurityActionAudit = {
      operation: "email_verification_request",
    ...
    return runSecurityAction(audit, async () => {
      ...
      audit.changes = { purpose, requestAccepted: true };
      return {
        success: true,
      };
    });
