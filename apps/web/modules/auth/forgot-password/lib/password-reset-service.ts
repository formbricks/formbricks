...
/** @deprecated Use ACCOUNT_RECOVERY_LINK_EMAIL_ERROR_CODE. */
export const PASSWORD_RESET_LINK_EMAIL_ERROR_CODE = ACCOUNT_RECOVERY_LINK_EMAIL_ERROR_CODE;
/** @deprecated Use ACCOUNT_RECOVERY_NOTIFICATION_EMAIL_ERROR_CODE. */
export const PASSWORD_RESET_NOTIFICATION_EMAIL_ERROR_CODE = ACCOUNT_RECOVERY_NOTIFICATION_EMAIL_ERROR_CODE;
