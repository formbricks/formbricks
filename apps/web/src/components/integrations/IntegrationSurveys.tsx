          ...
          elements: [
            {
              ...
              name: "dataIn",
              options: [
                { label: "Segment", value: "segment", frontend: { icon: SegmentLogo } },
                {
                  label: "Mixpanel",
                  value: "mixpanel",
                  frontend: { icon: MixpanelLogo },
                },
                { label: "Amplitude", value: "amplitude", frontend: { icon: AmplitudeLogo } },
                { label: "PostHog", value: "posthog", frontend: { icon: PosthogLogo } },
                { label: "Heap", value: "heap", frontend: { icon: HeapLogo } },
                { label: "June", value: "june", frontend: { icon: JuneLogo } },
              ],
          ...
          elements: [
            {
              ...
              options: [
                { label: "Segment", value: "segment", frontend: { icon: SegmentLogo } },
                {
                  label: "Hubspot",
                  value: "hubspot",
                  frontend: { icon: HubspotLogo },
                },
                { label: "customer.io", value: "customerio", frontend: { icon: CustomerIOLogo } },
                { label: "Salesforce", value: "salesforce", frontend: { icon: SalesforceLogo } },
                { label: "braze", value: "braze", frontend: { icon: BrazeLogo } },
              ],
              component: IconCheckbox,
            },
          ],
