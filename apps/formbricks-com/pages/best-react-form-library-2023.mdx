...
Not using Tailwind? Maybe you should 😛 Jokes aside, you can also pass a custom stylesheet and Formbricks React will apply it to your form. As soon as the React Lib is in public beta, we’ll add a step-by-step tutorial [in our docs](/docs).
