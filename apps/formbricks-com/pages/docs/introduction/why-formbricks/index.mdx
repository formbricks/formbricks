...
A common idea is to just "build it ourselves". Forms and surveys appear to be quick to build but once you get started you notice that it gets complicated quickly. Validation, spam protection, internationalisation, schemas or supported data analysis are just a few of the things you want, but don't want to build yourself. And you shouldn't, someone already wrote that code, you just cannot use it. This is changing with Formbricks.
