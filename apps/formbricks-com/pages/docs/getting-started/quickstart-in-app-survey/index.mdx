...
In app surveys have 6-10x better conversion rates then emailed out surveys. This tutorial explains how to run an in app survey in your web app in 10 to 15 minutes. Let’s go!
...
Go back to [app.formbricks.com](http://app.formbricks.com) and check go to the Setup Checklist in the Settings. If the status is still indicated as “Not connected” your app hasn't yet pinged the Formbricks Cloud:
...
1. Open your local app in an incognito tab or window. The New Session event is only fired if a user was inactive for X or was logged out of Formbricks via formrbicks.logout().
2. Check the debug logs for “Event ‘New Session” tracked”. If you see it in the logs and the survey still did not get displayed, [pls let us know.](mailto:support@formbricks.com)
