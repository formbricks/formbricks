...
The Feedback Box gives your userss a direct channel to share their feedback and feel heard.
...
Then, create a new survey and select the "survey and select the "Feedback Box" template" template:
