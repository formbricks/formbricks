...
Surveying your user base without segmentation leads to weak results and survey fatigue. Attributes help you segment your into groups.
...
Attributes are sent from your application to Formbricks along with the user ID of the current user. We store it in our database and allow you to use it the next time you create a survey.
