...
To prefill the first question of a survey, append `?question_id=answer` at the end of the survey URL.
...
```tsx
https://app.formbricks.com/s/clin3yxja52k8l80hpwmx4bjy?single_select_question_id=Very disappointed
...
```tsx
https://app.formbricks.com/s/clin3yxja52k8l80hpwmx4bjy?single_select_question_id=Sun,Palms,Beach
...
```tsx
https://app.formbricks.com/s/clin3yxja52k8l80hpwmx4bjy?openText_question_id=I love Formbricks
