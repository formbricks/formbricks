...
<Image
  src={HeaderImage}
  alt="OhMyForm open source alternative comparison with Formbricks React Library"
...
Getting OhMyForm up and running ended up to be a lot more time-consuming than expected. DockerHub should make it really easy but it does’nt work. Apart from that, the lack of documentation makes it quite tedious for beginners. The Quick Start Guide is very basic and does not give any hints on how to troubleshoot if the installation doesn’t work.
