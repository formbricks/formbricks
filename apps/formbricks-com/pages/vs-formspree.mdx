...
Our [React Form Builder](/react-form-library) makes it super easy to build custom forms rapidly with. Today, we’ll talk about how the Formbricks [Core API](/core-api) + [Formbricks HQ](/formbricks-hq) completely eliminate the need to setup your own backend to receive, manage and analyze submissions from forms and surveys.
