...
Our [React Form Builder](/react-form-builder) makes it super easy to build custom forms rapidly with. Today, we’ll talk about how the Formbricks [Core API](/core-api) + [Form HQ](/form-hq) completely eliminate the need to setup your own backend to receive, manage and analyze submissions from forms and surveys.
