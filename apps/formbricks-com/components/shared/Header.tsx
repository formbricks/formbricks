    ...
    <Popover className="relative" as="header">
      <div className="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
        ...
        <div className="-my-2 -mr-2 md:hidden">
          <Popover.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-gray-100 rounded-md hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 dark:bg-blue-700 dark:text-blue-200">
      ...
      <Transition
        ...
        <Popover.Panel
          ...
          <div className="bg-gray-100 divide-y-2 rounded-lg shadow-lg dark:divide-blue divide-gray-50 ring-1 ring-black ring-opacity-5 dark:bg-blue-900">
            <div className="px-5 pt-5 pb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <Popover.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-white rounded-md hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 dark:bg-blue-700 dark:text-blue-200">
              ...
              <nav className="relative px-5 py-6 bg-gray-100 dark:bg-blue-900">
                <div>
            ...
            <div className="px-5 py-6">
              <div className="grid grid-cols-3 text-sm font-medium text-center text-gray-900 hover:text-gray-700 dark:text-blue-200 sm:text-base">
