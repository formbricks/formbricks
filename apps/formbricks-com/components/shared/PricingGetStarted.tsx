...
export const GetStartedWithPricing = ({ showDetailed }: { showDetailed: boolean }) => {
  return (
    <>
      <div className="xs:flex block items-center justify-center gap-x-4 px-4 pb-4 md:gap-4 md:px-16">
        <div className="xs:w-1/3 w-full text-left text-sm text-slate-800 dark:text-slate-100">
