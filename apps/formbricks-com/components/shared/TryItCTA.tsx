  ...
  return (
    <div className="grid content-center max-w-md grid-cols-2 gap-10 px-4 pt-24 mx-auto pb-36 sm:max-w-3xl sm:px-6 lg:max-w-6xl lg:px-8">
      <div className="">
        ...
        <p className="mt-3 text-xl text-slate-500 dark:text-slate-300 sm:mt-4">
          Dive right in or browse docs for examples.
        </p>
        <p className="mb-3 text-xl text-slate-500 dark:text-slate-300 sm:mb-4">
      ...
      <div className="flex items-center">
        <div className="flex items-center justify-between w-full h-20 px-8 text-gray-100 bg-gray-800 rounded-lg ">
