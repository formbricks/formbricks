...
export default function HeadingCentered() {
  ...
  return (
    <div className="grid content-center max-w-md grid-cols-1 gap-10 px-4 py-12 mx-auto sm:max-w-3xl sm:px-6 md:grid-cols-2 md:pt-24 md:pb-36 lg:max-w-6xl lg:px-8">
      <div className="">
