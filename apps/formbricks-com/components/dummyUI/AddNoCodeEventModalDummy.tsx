...
export const AddNoCodeEventModalDummy: React.FC<EventDetailModalProps> = ({ open, setOpen }) => {
  return (
    <Modal open={open} setOpen={setOpen} noPadding>
      <div className="rounded-lg bg-slate-50 p-4 dark:bg-slate-800 sm:p-6">
        <div className="bg-slate-90 p-4 dark:bg-slate-700">
        ...
        <form className="space-y-4 p-4 sm:p-6">
          <div>
            ...
            <RadioGroup className="grid grid-cols-1 gap-2 sm:grid-cols-2">
              ...
              <div className="hidden items-center space-x-2 rounded-lg bg-slate-50 p-3 dark:bg-slate-600 md:flex">
                ...
                <Label htmlFor="cssSelector" className="flex cursor-not-allowed items-center text-slate-500">
                  CSS Selector
                </Label>
              </div>
            </RadioGroup>
          ...
          <div className="mt-6 flex justify-center pb-2 sm:mt-8 sm:justify-end">
