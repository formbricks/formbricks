...
<Image src={GitpodAuth} alt="Gitpod Auth Page" quality="100"className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
<Image src={GitpodNewWorkspace} alt="Gitpod New Worskpace Page" quality="100"className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
<Image src={GitpodPreparing} alt="Gitpod Preparing Worskpace Page" quality="100"className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
<Image src={GitpodRunning} alt="Gitpod Running Workspace Page" quality="100"className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
### Accessing port URLs
  ...
  <Image src={GitpodPorts} alt="Gitpod Ports tab" quality="100"className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
