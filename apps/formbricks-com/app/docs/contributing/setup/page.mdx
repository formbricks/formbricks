...
This method will set up your development environment for Formbricks on your local machine. This setup will have the Formbricks codebase and all the dependencies installed. 

Please note that this method is only for UNIX based systems.
