...
1. **Via URL Parameter:**
   ...
   - Enable debug mode mode by addong `?formbricksDebug=true` to your application's URL (e.g. `example.com?formbricksDebug=true` or `example.com?page=123&formbricksDebug=true`). This parameter will enable debugging for the current page.
