...
You can overwrite the default CSS styles for the in-app surveys by adding the following CSS to your global CSS file:

Make sure that you do not change the CSS variable names as they are used by Formbricks to identify the CSS variables. You can change the values to your liking.
