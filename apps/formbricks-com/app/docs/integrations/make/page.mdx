...
<Image src={EnterApiKey} alt="Enter API Key" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
<Image src={AddModule} alt="Add Module" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />

Choose "Add a Row" for the action:

<Image src={SelectAction} alt="Select Action" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />

Specify the spreadsheet details and match the Formbricks data:

<Image src={SelectFields} alt="Select Fields" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />

A new row gets added to the spreadsheet for every response:

<Image src={Result} alt="Result" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />