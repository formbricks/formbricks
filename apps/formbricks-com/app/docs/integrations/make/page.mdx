...
<Image src={EnterApiKey} alt="Enter API Key" quality="100" className="rounded-lg max-w-full    " />
...
<Image src={AddModule} alt="Add Module" quality="100" className="rounded-lg max-w-full    " />

Choose "Add a Row" for the action:

<Image src={SelectAction} alt="Select Action" quality="100" className="rounded-lg max-w-full    " />

Specify the spreadsheet details and match the Formbricks data:

<Image src={SelectFields} alt="Select Fields" quality="100" className="rounded-lg max-w-full    " />

A new row gets added to the spreadsheet for every response:

<Image src={Result} alt="Result" quality="100" className="rounded-lg max-w-full    " />
