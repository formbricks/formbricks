...
5. Add the **Redirect URLs** under **OAuth & Permissions** tab. You can add the following URLs:
   ...
   - If you are running formbricks locally, you can enter `https://localhost:3000/api/slack/callback`.
   - Or, you can enter `https://<your-public-facing-url>/api/slack/callback`
