...
- [Create Response](#create-a-response)
- [Update Response](#update-a-response)

---

## Create a response {{ tag: 'POST', label: '/api/v1/client/<environment-id>/responses' }}
...
## Update a response {{ tag: 'PUT', label: '/api/v1/client/<environment-id>/responses/<response-id>' }}
