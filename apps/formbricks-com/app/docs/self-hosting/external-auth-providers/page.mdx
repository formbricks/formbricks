export const meta = {
  title: "Integrating Google OAuth with Formbricks",
  description:
    "Simplify user access to your Formbricks instance by enabling Google OAuth. Follow our detailed guide to set up Google OAuth, ensuring a seamless login experience for your users. Need assistance? Our community is here to help.",
};
