...
| ------------------------- | -------- | ------------------------------------------------------------- | ----------------------------------------------------------- |
| ENCRYPTION_KEY            | true     | `openssl rand -base64 24 \| tr -dc 'a-zA-Z0-9' \| head -c 24` | Needed for 2 Factor Authentication                          |
| FORMBRICKS_ENCRYPTION_KEY | false    | `openssl rand -base64 16 \| tr -dc 'a-zA-Z0-9' \| head -c 16` | Needed if you want to use Single Use Surveys                |
| SHORT_SURVEY_BASE_URL     | false    | `<your-short-base-url>`                                       | Needed if you want to enable shorter links for Link Surveys |
