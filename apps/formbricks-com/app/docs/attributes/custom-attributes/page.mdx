...
## Setting Custom Attributes During Initialization

You can also set custom user attributes directly during the initialization of Formbricks for better user identification.
