...
<Image src={AddAction} alt="Add action" quality="100" className="rounded-lg max-w-full sm:max-w-2xl" />
...
<div className="grid grid-cols-2 space-x-2">
  <Image src={ActionCSS} alt="Add CSS action" quality="100" className="rounded-lg max-w-full sm:max-w-2xl" />
  <Image
    src={ActionInner}
...
<Image src={Publish} alt="Publish survey" quality="100" className="rounded-lg max-w-full sm:max-w-2xl" />
