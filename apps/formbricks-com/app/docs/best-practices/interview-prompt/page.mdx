...
<Image src={AddAction} alt="Add action" quality="100" className="rounded-lg max-w-full  " />
...
<div className="grid grid-cols-2 space-x-2">
  <Image src={ActionCSS} alt="Add CSS action" quality="100" className="rounded-lg max-w-full  " />
...
<Image src={Publish} alt="Publish survey" quality="100" className="rounded-lg max-w-full  " />
