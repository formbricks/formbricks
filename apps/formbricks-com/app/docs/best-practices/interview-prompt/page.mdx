...
<Image src={AddAction} alt="Add action" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
...
<div className="flex max-w-full flex-col sm:max-w-3xl lg:gap-1">
  <Image src={ActionCSS} alt="Add CSS action" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
  <Image
    src={ActionInner}
...
<Image src={Publish} alt="Publish survey" quality="100" className="rounded-lg max-w-full sm:max-w-3xl md:max-w-2xl" />
