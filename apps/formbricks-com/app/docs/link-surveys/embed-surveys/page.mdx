...
We also fire a **formbricksSurveyCompleted** event when a user finishes a survey within the embedded iframe. This event can be captured through a message listener in your webpage's JavaScript

### How to Use it?

1. Embed the Formbricks survey on your webpage using the iframe method as described in previous documentation.
