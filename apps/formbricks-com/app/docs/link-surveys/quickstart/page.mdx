...
## (Optional) Configure your survey settings

Configure the Response Options such as closing survey on a date or on based on number of responses, redirecting users to a URL after they complete the survey, protecting survey with a Pin, and many more options!
...
Configure the styling of your link survey such as background color, branding colors, progress bar visibility, etc.
